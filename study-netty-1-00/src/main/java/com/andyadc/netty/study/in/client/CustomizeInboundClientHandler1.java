...
public class CustomizeInboundClientHandler1 extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        ctx.channel().writeAndFlush(Unpooled.copiedBuffer("hello netty 1".getBytes(CharsetUtil.UTF_8)));
    }
