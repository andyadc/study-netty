...
public class CustomizeInboundClientHandler3 extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        ctx.channel().writeAndFlush(Unpooled.copiedBuffer("hello netty 3".getBytes(CharsetUtil.UTF_8)));
    }
